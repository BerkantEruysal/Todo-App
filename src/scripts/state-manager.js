...
export const addToShowedProjectsList = (project_id) =>
  _showedProjects.push(project_id);
export const removeFromShowedProjectsList = (project_id) => {
  _showedProjects.splice(_showedProjects.indexOf(project_id), 1);
};
export const getSelectedProject = () => _selectedProject;
export const setSelectedProject = (value) => {
  if (getProjectById(_selectedProject)) {
